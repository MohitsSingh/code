function  [p1,p2] = sift_mosaic_old(im1, im2,m1,m2)
...
[f1,d1] = vl_sift(im1g,'Levels',5) ;
[f2,d2] = vl_sift(im2g,'Levels',5) ;
% step = 4;
...
% [f2,d2] = vl_dsift(im1g,'Step',step,'Bounds',bounds2);

% f1(4,:) = 0;
% f2(4,:) = 0;
% [f1,d1] = vl_sift(im1g,'Frames',f1);
% [f2,d2] = vl_sift(im2g,'Frames',f2);

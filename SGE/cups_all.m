...
outDir = '/home/amirro/storage/obj_s40/cups';
ranges = {};
nSplits = 100;
...
code = 'cd /home/amirro/code/SGE; cups_parallel(baseDir,d,indRange,outDir)';
...
%%
cups_parallel(baseDir,d,ranges{1},outDir);
...
%     load(handsFileName,'shape');
%     pick  = esvm_nms(shape.boxes,.5);
%     top_bbs_train{k} = pick;
% end
% 
% save ~/storage/hands_s40/top_bbs_train.mat top_bbs_train
% 
...
% end
% 
% save ~/storage/hands_s40/top_bbs_test.mat top_bbs_test

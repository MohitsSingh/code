...
from Matlab. The Matlab session can run on any linux workstation,
as long as the cluster can be accessed through ssh without a password.
...
- delete_sge_logs.m
   ...
   These files are named ~/sge_parallel/run_matlab_script.[e|o][task_id].[job_id].

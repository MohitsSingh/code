...
load ~/storage/data/cache/detectors_5pascal_cat

clusters = makeLight(clusters,'sv','vis','cluster_samples');
save cat_clusters_lite clusters
toSave =0;
...
imwrite(clusters2Images(vis),'cat_test.jpg');

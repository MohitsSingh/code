function seg_scores = score_occluders_new(curImageData,regions,occlusionPatterns)
posemap =  90:-15:-90;
...
faceBox = region2Box(curImageData.occlusionPattern.face_mask);
faceScale = faceBox(4)-faceBox(2);

areaRatio = [rprops.Area]./nnz(curImageData.occlusionPattern.face_mask);

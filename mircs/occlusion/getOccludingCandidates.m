function [occludingRegions,occlusionPatterns,rprops] = getOccludingCandidates(im,curImageData)

occludingRegions = curImageData.occlusionPattern.regions;
% face_mask = poly2mask2(curImageData.face_poly,size2(im));
face_mask = curImageData.occlusionPattern.face_mask;
...
RR = directionalROI(im,mean(curImageData.mouth_poly,1),[0 1]',140);
RR = RR | face_mask;
...
mouth_center = mean(curImageData.mouth_poly,1);

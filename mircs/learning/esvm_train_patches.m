...
Npos = 10;
Nneg = 50;
[pos_set,neg_set]= esvm_generate_dataset_mircs(conf,clusters,A,neg_ids, Npos,Nneg);
% [Ipos,Ineg] = esvm_generate_dataset(Npos,Nneg)
models_name = conf.classes{conf.class_subset};
...
%% Define test-set
Ntest = 50;
test_set = esvm_generate_neg_dataset(conf,[B(1:10);neg_ids(100:150)]);
test_params = params;

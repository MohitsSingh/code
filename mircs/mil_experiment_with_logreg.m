...
% startup;
% 
% boxes = runObjectness(I,100,params);
% cd(pp);
% 
% clf;imshow(I);
%     hold on;
%     plotBoxes2(boxes(,[2 1 4 3]),'color','green','LineWidth',2);
% 
% 
...
%     
%     hold on;
%     plotBoxes2(boxes(k,[2 1 4 3]),'color','green','LineWidth',2);
%     pause;
% end
% 
% 
...
% lipBoxes_train_r_2 = round(inflatebbox(lipBoxes_train_r,[2 2],'pre'));
%lipBoxes_train_r_2 = round(inflatebbox(lipBoxes_train_r,[2 2],'both','abs'));
...
% lipBoxes_test_r_2 = round(inflatebbox(lipBoxes_test_r,[1 4],'post'));
...
% lipBoxes_train_r_2 = round(inflatebbox(lipBoxes_train_r,[2 2],'pre'));
lipBoxes_train_r_2 = round(inflatebbox(lipBoxes_train_r,[2 2],'both'));
lipImages_train = multiCrop(conf,train_faces,lipBoxes_train_r_2,[50 NaN]);

figure,imshow(multiImage(lipImages_train(t_train),false));

lipBoxes_test_r_2 = round(inflatebbox(lipBoxes_test_r,[2 2],'both'));
% lipBoxes_test_r_2 = round(inflatebbox(lipBoxes_test_r,[1 4],'post'));
lipImages_test = multiCrop(conf,test_faces,lipBoxes_test_r_2,[50 NaN]);
...
[q_tt2] = applyToSet(conf,clusters,train_faces,[],'drinkers_train2_ref','override',true);
[q_t2] = applyToSet(conf,clusters,test_faces,[],'drinkers_test2_ref','override',true);
...
% 
% ws = [];[~, ~, dt_train_1] = svmpredict(zeros(size(t_train,1),1),double(psix_train_face'),svmModel_bow_face);
...
feat_train_all = [dt_train_1(:),dt_train_2(:),dt_train_3(:),dt_train_4(:),dt_train_5(:),dt_train_6(:),dt_train_7,dt_train_8,dt_train_9,dt_train_10,dt_train_11(:),dt_train_12,train_faces_scores_r(:)];
feat_train_all = double(feat_train_all);
sel = [1 2 4 5 7 8 9 10 11 12 13] ;
% sel = [1];  % bow face - 18%
% sel = [3]; % hog face - 18&
% sel = [5];
...
feat_test_all = [dt_test_1(:),ddd*dt_test_2(:),dt_test_3_with_flip(:),dt_test_4(:),dt_test_5(:),dt_test_6(:),dt_test_7(:),dt_test_8(:),dt_test_9(:),dt_test_10(:),dt_test_11(:),dt_test_12,test_faces_scores_r(:)];

...
jj = 100;
I = ims1(:,:,:,jj);
prior_mask = fspecial('gauss',[80 80], 17);
prior_mask = prior_mask./max(prior_mask(:));
imagesc(prior_mask);
labelImage = local_segmentation(I,prior_mask);

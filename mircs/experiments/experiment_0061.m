...
% % vocab = vl_kmeans(res.x, 256, 'verbose', 'algorithm', 'elkan', 'MaxNumIterations', 50) ;
% load vocab
% save vocab vocab;
conf.vocabPath = 'vocab.mat';
...
if (length(size(im))==2)
    ...
    [frames,rects] = extractDNNFeats_tiled(im,net,[1:4 ; 1:4]',16,false)
% %     mm = 17;
% %     im = single(im);
% %     loc_min = [mm mm];

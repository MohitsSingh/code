function fcnTrain_action_objects_class_only(varargin)
...
opts.expDir = '/net/mraid11/export/data/amirro//fcn/data/fcn32s-action_class' ;
...
% if exist(opts.imdbPath)
  ...
  load ~/code/mircs/images_and_face_obj_x2.mat;

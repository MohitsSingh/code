function fcnTrain_action_objects_conditional(varargin)
...
opts.expDir = '/net/mraid11/export/data/amirro//fcn/data/fcn8s-action_obj_conditional' ;
...
%       dpc
  ...
  imdb.labels = masks;
  imdb.nClasses = 3;
  save('/home/amirro/storage/fcn/data/conditional_new_face_and_hand_and_obj/imdb.mat','imdb','train','val','test');
end
...
save('conditional_results/face_and_hand.mat','perfs','diags');

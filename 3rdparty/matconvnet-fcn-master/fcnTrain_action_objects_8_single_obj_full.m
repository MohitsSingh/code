% function fcnTrain_action_objects_8_single_obj_full(varargin)
...
opts.expDir = '/net/mraid11/export/data/amirro//fcn/data/fcn8s-fcnTrain_action_objects_8_single_obj_full' ;

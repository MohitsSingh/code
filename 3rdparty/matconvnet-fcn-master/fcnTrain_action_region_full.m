function fcnTrain_action_region_full(varargin)
...
opts.expDir = '/net/mraid11/export/data/amirro//fcn/data/fcn8s-fcnTrain_action_region_full' ;
...
if exist(opts.imdbPath)
  ...
  for t = 1:length(imdb.labels)
      imdb.labels{t} = uint8(imdb.labels{t}>0);
  end
  imdb.nClasses = 1;

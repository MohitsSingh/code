...
opts.expDir = '/net/mraid11/export/data/amirro//fcn/data/fcn8s_person_parts_focused_face_and_hand';
...
if exist(opts.imdbPath,'file')
    ...
    all_annos = all_annos(1:3:end); %small...
    imagePaths = {};
...
opts.train.learningRate = 0.00001 * ones(1,150) ; 
% was = 0.0001 * ones(1,150) ;, changed at epoch 69, to .00001

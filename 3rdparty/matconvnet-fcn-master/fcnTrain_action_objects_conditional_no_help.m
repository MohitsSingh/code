function fcnTrain_action_objects_conditional_no_help(varargin)
...
opts.expDir = '/net/mraid11/export/data/amirro//fcn/data/fcn8s-action_obj_conditional_no_help' ;
...
if exist(opts.imdbPath)
  ...
  for t = 1:length(masks)
      ...
      m(m<3) = 0; % TODO - THIS IS DONE TO MAKE THE ACTION OBJECT A SINGLE CLASS
      m(m>=3) = 1; % TODO - THIS IS DONE TO MAKE THE ACTION OBJECT A SINGLE CLASS
      masks{t} = m;
...
%% test it a bit...
%modelPath = '/net/mraid11/export/data/amirro//fcn/data/fcn8s-action_obj_conditional/net-epoch-1.mat' ;
...
for ipp = 1:length(ppp)
    pp = ppp(ipp);
    modelPath = ['/net/mraid11/export/data/amirro//fcn/data/fcn8s-action_obj_conditional/net-epoch-' num2str(pp) '.mat'];    

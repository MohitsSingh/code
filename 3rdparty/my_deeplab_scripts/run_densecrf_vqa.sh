...
#######################################
SAVE_DIR=/home/amirro/code/3rdparty/my_deeplab_scripts/workdir/res_W${Bi_W}_XStd${Bi_X_STD}_RStd${Bi_R_STD}_PosW${POS_W}_PosXStd${POS_X_STD}
...
FEATURE_DIR=/home/amirro/code/3rdparty/my_deeplab_scripts/workdir/test_images/fc8/

...
close all
load rain.mat
y = int32(X+1); % Convert from {0,1} to {1,2} representation
...
% Make nodeMap, edgeMap, and initialize parameter vector
ising = 1;
tied = 1;
...
% Add extra parameter that will be used for the node potential for the first/last day
w = zeros(6,1);
nodeMap(1,1) = 6;
nodeMap(end,1) = 6;

function [NLL,g,Ymemory] = UGM_CRF_NLL_MCMC(w,Xnode,Xedge,Y,nodeMap,edgeMap,edgeStruct,sampleFunc,varargin)
...
for i = 1:nInstances
    ...
    [nodeBel,edgeBel,logZ,samples] = UGM_Infer_Sample(nodePot,edgePot,edgeStruct,sampleFunc,varargin{:});
    
    Ymemory(i,:) = samples(:,end)';

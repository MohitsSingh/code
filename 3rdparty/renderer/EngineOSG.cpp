...
class MyTexture: public osgUtil::Optimizer::Optimizer::TextureVisitor {
public:
	MyTexture() :
...
public:
	...
	virtual void operator()(osg::RenderInfo& ri) const {
		...
		if (engine.getUnproject) {
			unProjectImage(engine.viewer, (GLfloat*) depthImage->data(), engine.unprojectOutput);
		}

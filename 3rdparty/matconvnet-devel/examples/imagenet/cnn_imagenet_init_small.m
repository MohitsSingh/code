function net = cnn_imagenet_init_small(varargin)
...
switch opts.model
  case 'alexnet'
    net.meta.normalization.imageSize = [67, 67, 3] ;
...
net.meta.normalization.border = 96 - net.meta.normalization.imageSize(1:2) ;
...
net = add_block(net, opts, '6', 1, 1, 256, 4096, 1, 0) ;

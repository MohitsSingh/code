function [net, info] = cnn_imagenet_small(varargin)
...
sfx = [sfx '-' opts.networkType '-small'] ;
...
net = cnn_imagenet_init_small('model', opts.modelType, ...
...
% profile on
net.meta.trainOpts.learningRate =[ net.meta.trainOpts.learningRate,ones(1,10)*0.00001,...
    ones(1,10)*0.000001];

function [net, info] = cnn_cifar_mod(varargin)
...
opts.expDir = fullfile('/net/mraid11/export/data/amirro/fcn/data/', 'data', ...
...
opts.expDir = [opts.expDir opts.exp_suffix];

opts.dataDir = fullfile(vl_rootnn, 'data','cifar') ; % this doesn't change.
...
% Apply data transformation to all elements in dataset
% for t = 1:length(data)
%
%
%
%     data{t} = opts.dataFun(data{t});
% end

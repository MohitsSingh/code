...
for i=1:length(test_iids) 
	...
	% load ridge_gt if you are using the automatically created ground-truth and 'gt' if you are using the human annotations 
	% (remember to change the variable in the rest of this function respectively)
        ...
        [cntR_notext,sumR_notext,cntP_notext,sumP_notext,scores_notext] = ...
            prScores(supImNoTexture,iid,ridge_gt,nthresh,'mil_notext',...
        ...
        if sflag
            ...
            [cntR_spectral,sumR_spectral,cntP_spectral,sumP_spectral,scores_spectral] = ...
                prScores(supImSpectral,iid,ridge_gt,nthresh,'mil_spectral',...
        ...
        [cntR_lind,sumR_lind,cntP_lind,sumP_lind,scores_lind] = ...
            prScores(contour_ridge,iid,ridge_gt,nthresh,'lind',...

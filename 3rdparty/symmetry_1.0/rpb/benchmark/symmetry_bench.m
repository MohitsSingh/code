...
groundPath = fullfile('/home','tsogkas','symmetry_detector','Groundtruth','test2');
betaPath = fullfile('/home','tsogkas','symmetry_detector','beta');
scorePath = fullfile('/home','tsogkas','symmetry_detector','scores','release_test');
nthresh = 50;

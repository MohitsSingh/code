...
colorType = colorTypes{2}; % Single color space for demo
...
k = 10; % controls size of segments of initial segmentation.
minSize = k;
%sigma = 0.8;
sigma = 0;
...
[boxes blobIndIm blobBoxes hierarchy] = Image2HierarchicalGrouping(im, sigma, k, minSize, colorTypes, simFunctionHandles);
